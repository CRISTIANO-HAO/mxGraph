...
Actions.prototype.init = function()
{
	...
	// 图模一体化事件
	this.addAction('save', function() { saveModelGraph(ui) }, null, null, Editor.ctrlKey + '+S').isEnabled = isGraphEnabled;
	this.addAction('newModel', function() { openNewModel(ui); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('openModel', function() {openModelList(ui); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('saveModel', function() { saveModelGraph(ui) }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('saveAsModel', function() {alert("占坑"); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('newProject', function() { alert("占坑"); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('openProject', function() { alert("占坑");}, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('saveProject', function() { alert("占坑"); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('saveAsProject', function() {alert("占坑"); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('newCase', function() { alert("占坑"); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('openCase', function() {alert("占坑"); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('saveCase', function() { alert("占坑"); }, null, null, '').isEnabled = isGraphEnabled;
	this.addAction('saveAsCase', function() { alert("占坑");}, null, null, '').isEnabled = isGraphEnabled;
