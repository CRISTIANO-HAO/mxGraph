...
Menus.prototype.init = function()
{
	...
	this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		...
		this.addSubmenu('model', menu, parent);
		this.addSubmenu('project', menu, parent);
		this.addSubmenu('case', menu, parent);
		this.addMenuItems(menu, ['save','-', 'import', 'export', '-', 'pageSetup', 'print'], parent);
	})));
	this.put('model', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['newModel', 'openModel','saveModel','saveAsModel'], parent);
	})));
	this.put('project', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['newProject', 'openProject','saveProject','saveAsProject'], parent);
	})));
	this.put('case', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['newCase', 'openCase','saveCase','saveAsCase'], parent);
	})));
	...
	if (!graph.isSelectionEmpty())
	{
		...
		if (state != null)
		{
			...
			if (graph.getSelectionCount() == 1)
			{
				...
				this.addMenuItems(menu, ['edit', '-', 'editLink'], null, evt);
