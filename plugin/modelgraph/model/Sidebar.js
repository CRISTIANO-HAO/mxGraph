...
Sidebar.prototype.init = function()
{
	...
	// 基本绘图元素
	// this.addStencilPalette('basic', '基本图元', dir + '/basic2.xml',';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');

	// 电网元件
	this.addStencilPalette('electrical', mxResources.get('electricalElement'), dir + '/electrical.xml',
		';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=1',null, null, null, null, [
			this.createEdgeTemplateEntry('endArrow=none;html=1;strokeWidth=2;fillColor=#000;strokeColor=#000;shape=lineStyle;', 100, 0, '', '线路', 'line', 'line')
	]);

	//this.addStencilPalette('electrical', '电气图元2', dir + '/electrical2.xml',';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
};
...
Sidebar.prototype.addSearchPalette = function(expand)
{
	...
	input.style.border = 'solid 1px rgb(140, 141, 195)';
...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	this.addPaletteFunctions('bpmn', 'BPMN ' + mxResources.get('general'), expand || false, fns);
};
...
Sidebar.prototype.createEdgeTemplate = function(style, width, height, value, title, showLabel, allowCellsInserted)
{
	...
	cell.geometry.setTerminalPoint(new mxPoint(0, height), false);
	cell.geometry.setTerminalPoint(new mxPoint(width, 0), true);
	cell.geometry.relative = true;
	cell.edge = true;
