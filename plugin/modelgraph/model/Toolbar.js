...
Toolbar.prototype.init = function()
{
	...
	if (sw >= 400)
	{
		...
		if (sw >= 440)
		{
			this.edgeShapeMenu = this.addMenuFunction('', mxResources.get('lineShape'), false, mxUtils.bind(this, function(menu)
			{
		...
		this.edgeStyleMenu = this.addMenuFunction('geSprite-orthogonal', mxResources.get('lineWaypoint'), false, mxUtils.bind(this, function(menu)
		{
